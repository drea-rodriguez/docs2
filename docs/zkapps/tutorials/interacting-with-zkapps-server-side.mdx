...
Note Tutorial 3, and this tutorial, reuse the smart contract `Square` from [Tutorial 1](hello-world). You can watch a <a href="https://youtu.be/B5mniTExWaY">similar tutorial</a> that walks you through how to interact with the zkApp contract from code.
...
<ResponsiveVideo src="https://www.youtube.com/embed/B5mniTExWaY" />
